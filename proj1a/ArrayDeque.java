...
public class ArrayDeque<T>{
	...
	private int head = defaultLength-1; /** position of first element of the array */
	private int tail = 0; /** position of last element of the array */
